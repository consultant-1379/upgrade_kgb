...
public class AnalyseWorkflowResultsTest extends TorTestCaseHelper implements TestCase {
    
    final static Logger logger = LoggerFactory.getLogger(AnalyseWorkflowResultsTest.class);
