...
public class CacheLatestMediaOnMwsScenario extends TorTestCaseHelper implements TestCase {
	
	
    @Inject
    CacheLatestMediaOnMwsTestSteps steps;
   
    @TestId(id = "OSS_55386", title = "OSS-RC ORCH CDB: Cache Latest media available in shipment to MWS")
    @Test
